// src/components/Chart/Drawings/tools/FibonacciTool.js
...
export class FibonacciTool extends ToolBase {
  constructor(defaultStyle) {
    super("fibonacci", defaultStyle);
  ...
  onBegin(engine, pointer) {
    ...
    this.preview = new FibonacciRetracement(this._a, this._a);
  ...
  onDragMove(engine, pointer) {
    ...
    // ✅ precisa atualizar WORLD também, senão não tem “altura” e o preview fica travado
  ...
  onEnd(engine, pointer, { commit } = {}) {
    ...
    const obj = new FibonacciRetracement(canonicalA, canonicalB);
    obj.aScreen = { ...aS };
    obj.bScreen = { ...bS };
